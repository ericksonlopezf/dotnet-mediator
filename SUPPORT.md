...
If you need help with `EricksonLopez.Mediator`, there are a few ways to get it:

* **Read the Documentation:** You can find extensive technical documentation in our [docs folder](docs/). Recommended starting points:
  * [Architecture Overview](docs/architecture.md)
  * [Package Catalog & Setup](docs/packages.md)
...
Currently, support is provided on a best-effort basis by the open-source maintainers and community. Enterprise SLAs and dedicated consulting can be requested by contacting [ericksonlopezf@gmail.com](mailto:ericksonlopezf@gmail.com).

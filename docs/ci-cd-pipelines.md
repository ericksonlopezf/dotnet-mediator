...
| **Consolidated Gate** | `mutation-gate-summary` job aggregates all JSON reports, calculates ecosystem-wide mutation score, and publishes GitHub Commit Status (`mutation-testing/stryker`) |
